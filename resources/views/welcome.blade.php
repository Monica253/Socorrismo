...
<x-app-layout>
    <div id="container" class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-10 py-10 z-0">
        <h1 class="text-4xl text-gray-700 font-bold mb-4">{{ __('Home') }}</h1>


        <!--Dark mode-->
        <div class="bg-gray-200 dark:bg-gray-800 h-20 w-full">
            <button id="switchTheme" class="bg-blue-500 dark:bg-red-500">poner oscuro</button>
        </div>
